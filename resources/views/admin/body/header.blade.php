 ...
 @endphp
                        ...
                        <div class="dropdown d-inline-block user-dropdown">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user"  src="{{ (!empty($adminData->profile_image))? url('upload/admin_images/'.$adminData->profile_image):url('upload/admin_images/no_image.jpg') }}" alt="Header Avatar">
            ...
            <a class="dropdown-item d-block" href=""><span class="badge bg-success float-end mt-1"></span><i class="ri-settings-2-line align-middle me-1"></i>Password Change</a>
                                <a class="dropdown-item d-block" href="#"><span class="badge bg-success float-end mt-1"></span><i class="ri-settings-2-line align-middle me-1"></i> Settings</a>
